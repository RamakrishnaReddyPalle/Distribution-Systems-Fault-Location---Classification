...
%% Configuration 603 - corrected series reactance - ohm/mile

R_603 = [0.3192 0.2891 0.3192; 0.2891 0.3294 0.2066; 0.3192 0.2066 0.3238];
X_603 = [0.8900 0.4671 0.4591; 0.4671 1.3471 0.4591; 0.4591 0.4591 1.3569];

% charging susceptance - microsiemens/mile

B_603 = [4.7097 1.8999 1.2595; 1.8999 4.7097 0.8999; 1.2595 0.8999 4.6658];
...
%% Configuration 604 - corrected series reactance - ohm/mile

R_604 = [1.3238 0.8192 0.2066; 0.8192 1.2891 0.4192; 0.2066 0.4192 1.3294];
X_604 = [1.3569 0.9471 0.6591; 0.9471 1.4041 0.5328; 0.6591 0.5328 1.3471];

% charging susceptance - microsiemens/mile

B_604 = [4.6658 2.6658 1.2999; 2.6658 4.7097 1.1999; 1.2999 1.1999 4.7097];
...
%% Configuration 605 - corrected series reactance - ohm/mile

R_605 = [1.3292 0.8 0.8; 0.8 1.3292 0.8; 0.8 0.8 1.3292];
X_605 = [1.3475 0.6 0.6; 0.6 1.3475 0.6; 0.6 0.6 1.3475];

% charging susceptance - microsiemens/mile

B_605 = [4.5193 1.0 1.0; 1.0 4.5193 1.0; 1.0 1.0 4.5193];
...
%% Configuration 607 - corrected series reactance - ohm/mile

R_607 = [1.3425 1.0 1.0; 1.0 1.3425 1.0; 1.0 1.0 1.3425];
X_607 = [0.5124 0.4 0.4; 0.4 0.5124 0.4; 0.4 0.4 0.5124];

% charging susceptance - microsiemens/mile

B_607 = [88.9912 80.0 80.0; 80.0 88.9912 80.0; 80.0 80.0 88.9912];
